...
</td></tr><tr><td bgcolor=ffffff>作者</td><td bgcolor=ffffff><?=ECMS_ShowEditorVar("writer",$ecmsfirstpost==1?"":stripSlashes($r[writer]),"Default","","300","100%")?>
    ...
    <td bgcolor="#FFFFFF"><input name="repimgnexturl" type="checkbox" id="repimgnexturl" value="1"> 图片链接转为下一页&nbsp;&nbsp; <input name="autopage" type="checkbox" id="autopage" value="1">自动分页
      ...
      *高
      <input name="getfirsttitlespich" type="text" id="getfirsttitlespich" size="3" value="<?=$public_r[spicheight]?>">
        ...
        </table></td></tr><tr><td bgcolor=ffffff>信息来源</td><td bgcolor=ffffff><?=ECMS_ShowEditorVar("befrom",$ecmsfirstpost==1?"":stripSlashes($r[befrom]),"Default","","300","100%")?>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5">
          <tr> 
            <td bgcolor="#FFFFFF"> <input name="dokey" type="checkbox" value="1"<?=$r[dokey]==1?' checked':''?>>
              关键字替换&nbsp;&nbsp; <input name="copyimg" type="checkbox" id="copyimg" value="1">
