...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>上传资料</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>产品描述</td><td bgcolor='ffffff'>
<textarea name="smalltext" cols="60" rows="10" id="smalltext"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[smalltext]))?></textarea>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>主要特点</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("writers",$ecmsfirstpost==1?"":stripSlashes($r[writers]),"Default","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>应用领域</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("befroms",$ecmsfirstpost==1?"":stripSlashes($r[befroms]),"Default","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>技术参数</td><td bgcolor='ffffff'>
